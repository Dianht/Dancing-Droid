...
pub fn crash(tmp: (i32, i32), robot: &mut Vec<R>, m: usize, crash: &mut Vec<C>) {
...
pub fn limit(tmp: (i32, i32), robot: &mut Vec<R>, m: usize, crash: &mut Vec<C>, terrain: &mut T) {
