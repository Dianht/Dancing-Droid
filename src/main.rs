...
fn main() {
    ...
    let mut vecteur = vec![Robot{ id: "Blitz".to_string(), orientation: "North".to_string(),instructions: ["F","L","L","F","R","F"].to_vec(),x: 1,y: 1 },
                             Robot{ id: "Dinabot".to_string(), orientation: "North".to_string(),instructions: ["R","F","L"].to_vec(),x: 2,y: 2}];
